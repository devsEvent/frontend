  ...
  return (
    <footer className="bg-secondary">
      <div className="mt-20 px-9 py-12 relative mx-auto max-w-full xl:max-w-[95rem] bg-secondary flex justify-between flex-wrap gap-y-8 footer-background">
        ...
        <div className="flex w-full lg:w-fit gap-x-20">
          <div>
        ...
        <button
          ...
          className="absolute flex items-center justify-center w-12 h-12 rounded-full left-3 bottom-3 lg:left-4 lg:bottom-4 bg-primary lg:h-14 lg:w-14"
        >
          <Image src={ArrowUpIcon} alt="" />
        </button>
      </div>

      <div className="flex flex-col-reverse items-center justify-between px-6 py-4 lg:px-9 lg:py-2 bg-primary lg:flex-row gap-y-3">
